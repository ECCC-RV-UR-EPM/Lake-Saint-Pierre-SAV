# -*- coding: utf-8 -*-
"""Train the final daily TSS models with LOYO validation."""
...
# PATH
# ============================================================
DATA_FILE = os.path.abspath(os.path.join(HERE, "..", "Data", "02_tss", "TSS_prediction_LSP", "TSS_training_daily_filled.xlsx"))
...
print("\n FINAL MODEL READYsplit version")
