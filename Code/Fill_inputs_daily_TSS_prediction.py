...
prediction_dir = os.path.join(base_dir, "Prediction\TSS_prediction_expanded")
out_dir = os.path.join(base_dir, "Prediction\TSS_prediction_filled_parquet")
...
files = sorted(
    (
        f for f in glob.glob(os.path.join(prediction_dir, "TSS_prediction_*.txt"))
...
for file in files:
    ...
    # =====================================================
    # =====================================================
    out_path = os.path.join(out_dir, f"TSS_{year}.parquet")
