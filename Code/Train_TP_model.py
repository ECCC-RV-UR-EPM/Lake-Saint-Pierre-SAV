# -*- coding: utf-8 -*-
"""Train the final daily TP models with LOYO validation."""
...
# PATH
# ============================================================
DATA_FILE = os.path.abspath(os.path.join(HERE, "..", "Data", "03_tp_tn", "TP_prediction_LSP", "TP_training_daily_filled.xlsx"))
