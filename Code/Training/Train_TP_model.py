...
# PATH
# ============================================================
DATA_FILE = r"E:\SAV_map_PNAS\Submission_package\Data\03_tp_tn\TP_prediction_LSP\TP_training_daily_filled.xlsx"
OUTPUT_DIR = os.path.join(os.path.dirname(DATA_FILE), "Final_Model_TP_noTotal")
...
FEATURES = [
    ...
    "In_TP_YamaskaRiver", "In_TP_Saint_FrancoisRiver",
    "In_TP_NicoletRiver", "In_TP_MaskinongeRiver",
    "In_TP_DuLoupRiver", "In_TP_YamachicheRiver",
...
# Save fold-level and summary LOYO metrics for reporting and reproducibility.
metrics_df = pd.DataFrame(metrics_rows)
metrics_file = os.path.join(OUTPUT_DIR, "TP_LOYO_metrics_by_year_group.csv")
...
summary_file = os.path.join(OUTPUT_DIR, "TP_LOYO_metrics_summary.csv")
