...
# PATH
# ============================================================
DATA_FILE = r"E:\SAV_map_PNAS\Submission_package\Data\02_tss\TSS_training_daily_filled.xlsx"
OUTPUT_DIR = os.path.join(os.path.dirname(DATA_FILE), "Final_Model_TSS_noTotal")
...
# Save LOYO metrics for reporting and reproducibility.
metrics_df = pd.DataFrame(metrics_rows)
metrics_file = os.path.join(OUTPUT_DIR, "TSS_LOYO_metrics_by_year_group.csv")
...
summary_file = os.path.join(OUTPUT_DIR, "TSS_LOYO_metrics_summary.csv")
