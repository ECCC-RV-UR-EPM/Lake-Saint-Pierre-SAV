# =========================================================
# TP PREDICTION 2001–2024（FINAL FIXED ORIENTATION）
# =========================================================
...
model_path = os.path.join(base_dir, "Final_Model_TP_noTotal", "TP_final_model_noTotal.pkl")
...
# FILES
# =========================================================
files = sorted(glob.glob(os.path.join(input_dir, "TP_*.parquet")))
