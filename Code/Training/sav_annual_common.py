...
DATA_ROOT = PACKAGE_ROOT / "Data" / "Training"
PIPELINE_ROOT = DATA_ROOT / "SAV_Code_Training"
SRC = PIPELINE_ROOT / "Training_data"
...
# Paper-version polygon used by the published cascade-v3 training/prediction.
# Keep north_polygon.json as the newer alternative; do not silently substitute it,
# because north_flag and its interaction terms are model predictors.
NORTH_POLY_FILE = DATA_ROOT / "Spatial_constraints" / "north_polygon_paper.json"
FIX_FILE = DATA_ROOT / "Spatial_constraints" / "Lakesides_mainchannel_southarea.xlsx"
GRID_KM2 = 0.04
